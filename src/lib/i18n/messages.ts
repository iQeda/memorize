...
export const messages = {
  en: {
    ...
    "reviewer.showQuestion": "Show question",
    ...
    "reviewer.audioSettings": "Audio settings",
    ...
    "settings.subtitle":
      "Manage your collection, sync, backups, appearance, and shortcuts.",
    ...
    "settings.collectionNotOpen": "No collection open. Open an existing one or create a new one below.",
    ...
    "backup.collectionRequired": "Open an existing collection or create a new one to back up.",
    ...
    "sync.logout": "Log out",
    "sync.now": "Sync now",
    "sync.collectionRequired": "Open an existing collection or create a new one to sync.",
    ...
    "io.tsvDelimiter": "Separator",
    "io.tsvColumns": "Columns",
    "io.tsvDupe": "On duplicate",
    "io.tsvDupeUpdate": "Update existing",
    "io.tsvDupePreserve": "Keep existing",
    "io.tsvDupeDuplicate": "Add as new",
    "io.tsvPreview": "Preview",
    "io.tsvImportConfirm": "Import",
    "io.tsvCancel": "Cancel",
  ...
  ja: {
    ...
    "titlebar.syncError": "同期エラー",
    "titlebar.toggleTheme": "テーマ切替",

    // Decks page
    "decks.selectedHeader": "選択中のデッキ",
    "decks.studyNow": "学習を開始",
    "decks.cardsWaiting": "{count} 枚待機中",
    ...
    "decks.separateInactive": "停止中/保留 を分離",
    ...
    "browse.searchHint": "Anki 検索構文に対応",
    "browse.addWord": "単語を追加",
    "browse.cardsCount": "{count} 枚",
    ...
    "settings.title": "設定",
    "settings.subtitle":
      "コレクション・同期・バックアップ・外観・ショートカットを管理します。",
    "settings.contents": "目次",
    "settings.group.data": "データ",
    "settings.group.preferences": "環境設定",
    ...
    "settings.collectionNotOpen": "コレクションが開いていません。既存のものを開くか、下のボタンから新規作成してください。",
    ...
    "settings.shortcut.again": "もう一度",
    "settings.shortcut.hard": "難しい",
    ...
    "backup.collectionRequired": "バックアップするには、既存のコレクションを開くか新しく作成してください。",
    ...
    // AnkiWeb Sync
    "sync.title": "AnkiWeb 同期",
    "sync.signedInAs": "{username} としてログイン中",
    "sync.logout": "ログアウト",
    "sync.now": "今すぐ同期",
    "sync.collectionRequired": "同期するには、既存のコレクションを開くか新しく作成してください。",
    ...
    "io.tsvDelimiter": "区切り文字",
    "io.tsvColumns": "列数",
    "io.tsvDupe": "重複時の挙動",
    "io.tsvDupeUpdate": "既存を更新",
    "io.tsvDupePreserve": "既存を維持",
    "io.tsvDupeDuplicate": "新規として追加",
    "io.tsvPreview": "プレビュー",
    "io.tsvImportConfirm": "インポート",
    "io.tsvCancel": "キャンセル",
    "io.exportLabel": "全デッキを .apkg にエクスポート",
    "io.exportBody": "共有・移行用 (1 ファイルにまとめて出力)",
    "io.exportButton": "エクスポート…",
    "io.includeMedia": "メディアを含める",
    "io.includeScheduling": "スケジューリングを含める",
    "io.includeDeckConfigs": "デッキ設定を含める",
    "io.lastExport": "最終エクスポート: {path}",
    "io.statNew": "新規",
    "io.statUpdated": "更新",
    "io.statMatched": "一致更新",
    "io.statDuplicate": "重複",
    "io.statConflicting": "衝突",
    "io.statFound": "検出",
  },
} as const;
